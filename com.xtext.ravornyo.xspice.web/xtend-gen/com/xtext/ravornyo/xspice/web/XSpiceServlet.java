...
import com.xtext.ravornyo.xspice.web.XSpiceWebSetup;
...
public class XSpiceServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new XSpiceWebSetup().createInjectorAndDoEMFRegistration();
