...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Current Switch Model</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.xtext.ravornyo.xspice.xSpice.impl.CurrentSwitchModelImpl#getThreshold <em>Threshold</em>}</li>
 *   <li>{@link com.xtext.ravornyo.xspice.xSpice.impl.CurrentSwitchModelImpl#getHysteresis <em>Hysteresis</em>}</li>
 *   <li>{@link com.xtext.ravornyo.xspice.xSpice.impl.CurrentSwitchModelImpl#getOnResistance <em>On Resistance</em>}</li>
 *   <li>{@link com.xtext.ravornyo.xspice.xSpice.impl.CurrentSwitchModelImpl#getOffResistance <em>Off Resistance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CurrentSwitchModelImpl extends EntityImpl implements CurrentSwitchModel
{
  /**
   ...
   * @generated
   */
  protected CurrentSwitchModelImpl()
  {
    super();
  }
  ...
  {
    return XSpicePackage.Literals.CURRENT_SWITCH_MODEL;
  }
  ...
  public void setThreshold(BigDecimal newThreshold)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XSpicePackage.CURRENT_SWITCH_MODEL__THRESHOLD, oldThreshold, threshold));
  }
  ...
  public void setHysteresis(BigDecimal newHysteresis)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XSpicePackage.CURRENT_SWITCH_MODEL__HYSTERESIS, oldHysteresis, hysteresis));
  }
  ...
  public void setOnResistance(BigDecimal newOnResistance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XSpicePackage.CURRENT_SWITCH_MODEL__ON_RESISTANCE, oldOnResistance, onResistance));
  }
  ...
  public void setOffResistance(BigDecimal newOffResistance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XSpicePackage.CURRENT_SWITCH_MODEL__OFF_RESISTANCE, oldOffResistance, offResistance));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XSpicePackage.CURRENT_SWITCH_MODEL__THRESHOLD:
        return getThreshold();
      case XSpicePackage.CURRENT_SWITCH_MODEL__HYSTERESIS:
        return getHysteresis();
      case XSpicePackage.CURRENT_SWITCH_MODEL__ON_RESISTANCE:
        return getOnResistance();
      case XSpicePackage.CURRENT_SWITCH_MODEL__OFF_RESISTANCE:
