 ...
 * </p>
 * <ul>
 *   <li>{@link com.xtext.ravornyo.xspice.xSpice.impl.CurrentSourceImpl#getDc <em>Dc</em>}</li>
 *   <li>{@link com.xtext.ravornyo.xspice.xSpice.impl.CurrentSourceImpl#getAc <em>Ac</em>}</li>
 *   <li>{@link com.xtext.ravornyo.xspice.xSpice.impl.CurrentSourceImpl#getWaveform <em>Waveform</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CurrentSourceImpl extends ComponentImpl implements CurrentSource
{
  /**
  ...
  {
    return XSpicePackage.Literals.CURRENT_SOURCE;
  }
  ...
  public void setDc(BigDecimal newDc)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XSpicePackage.CURRENT_SOURCE__DC, oldDc, dc));
  }
  ...
  public EList<BigDecimal> getAc()
  {
    if (ac == null)
    {
      ac = new EDataTypeEList<BigDecimal>(BigDecimal.class, this, XSpicePackage.CURRENT_SOURCE__AC);
    }
    return ac;
  }
  ...
  public NotificationChain basicSetWaveform(Waveform newWaveform, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XSpicePackage.CURRENT_SOURCE__WAVEFORM, oldWaveform, newWaveform);
  ...
  public void setWaveform(Waveform newWaveform)
  {
    if (newWaveform != waveform)
    {
      ...
      if (waveform != null)
        msgs = ((InternalEObject)waveform).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XSpicePackage.CURRENT_SOURCE__WAVEFORM, null, msgs);
      if (newWaveform != null)
        msgs = ((InternalEObject)newWaveform).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XSpicePackage.CURRENT_SOURCE__WAVEFORM, null, msgs);
      msgs = basicSetWaveform(newWaveform, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XSpicePackage.CURRENT_SOURCE__WAVEFORM, newWaveform, newWaveform));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XSpicePackage.CURRENT_SOURCE__WAVEFORM:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XSpicePackage.CURRENT_SOURCE__DC:
        return getDc();
      case XSpicePackage.CURRENT_SOURCE__AC:
        return getAc();
      case XSpicePackage.CURRENT_SOURCE__WAVEFORM:
        return getWaveform();
    }
